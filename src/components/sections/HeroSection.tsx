...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen pt-28 sm:pt-36 pb-14 sm:pb-20 flex flex-col justify-between overflow-hidden bg-slate-900 dark:bg-[#0B1929] text-white transition-colors duration-300 scroll-mt-28 theme-hero-bg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 sm:space-y-8">
            <AnimatePresence mode="wait">
              ...
              >
                {/* Badge */}
                <div className="inline-flex items-center gap-2 sm:gap-2.5 px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-full bg-[#112236]/90 border border-[#C9A961]/40 shadow-lg backdrop-blur-md">
                  <div className="flex items-center justify-center w-5 h-5 rounded-full bg-[#C9A961]/20 text-[#C9A961] shrink-0">
                    <ShieldCheck className="w-3.5 h-3.5" />
                  </div>
                  <span className="text-xs sm:text-sm font-semibold text-[#C9A961] truncate max-w-[220px] sm:max-w-none">
                    {lang === 'ar'
                      ? currentSlide.badgeAr || settings.heroBadgeAr
                      : currentSlide.badgeEn || settings.heroBadgeEn}
                  </span>
                  <span className="w-2 h-2 rounded-full bg-[#C9A961] animate-ping shrink-0" />
                </div>

                {/* Title */}
                <h1 className={`text-2xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold tracking-tight leading-[1.2] gold-gradient-text break-words ${
            ...
            <div className="flex flex-wrap gap-x-4 sm:gap-x-6 gap-y-2 text-xs sm:text-sm text-slate-300 font-medium pt-1">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 pt-2">
              <button
                ...
                className="gold-gradient-bg text-[#0B1929] hover:brightness-110 font-bold text-sm sm:text-base px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl shadow-xl shadow-[#C9A961]/25 transition-all flex items-center justify-center gap-2.5 cursor-pointer group"
              >
                <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-[#0B1929] shrink-0" />
              ...
              <a
                href="#services"
                className="px-6 sm:px-7 py-3.5 sm:py-4 rounded-xl bg-[#112236]/90 hover:bg-[#182d46] text-slate-200 border border-slate-700/80 font-semibold text-sm sm:text-base transition-all flex items-center justify-center gap-2 hover:border-[#C9A961]/50"
              >
            ...
            <div className="relative rounded-3xl overflow-hidden border border-[#C9A961]/50 shadow-2xl bg-[#112236] group">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="relative h-[280px] sm:h-[400px] lg:h-[500px] xl:h-[540px] w-full overflow-hidden"
                >
                  <motion.img
                    src={
                      currentSlide.image && !currentSlide.image.includes('photo-1541888946425-d0fbb186a5b3')
      ...
      <div className="relative z-10 mt-10 sm:mt-16 border-t border-slate-800/80 bg-[#08121f]/90 backdrop-blur-xl py-6 sm:py-8">
        <div className="max-w-7xl 2xl:max-w-[1650px] 3xl:max-w-[1850px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 md:gap-8">
            {stats.map((stat, idx) => {
              const Icon = stat.icon;
              return (
                <div key={idx} className="flex items-center gap-2.5 sm:gap-4 group min-w-0 bg-slate-900/40 md:bg-transparent p-2 sm:p-0 rounded-xl">
                  <div className="flex items-center justify-center w-9 h-9 sm:w-12 sm:h-12 rounded-xl bg-[#112236] border border-[#C9A961]/30 text-[#C9A961] group-hover:scale-110 transition-transform shadow-md shrink-0">
                    <Icon className="w-4 h-4 sm:w-6 sm:h-6" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <div className="text-lg sm:text-2xl lg:text-3xl font-extrabold text-white font-mono flex items-center leading-none">
                      <span>{stat.value}</span>
                      <span className="text-[#C9A961]">{stat.suffix}</span>
                    </div>
                    <div className="text-[10px] sm:text-xs text-slate-400 font-medium mt-1 leading-snug break-words">
